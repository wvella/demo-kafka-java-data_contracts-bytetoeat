...
PROPERTIES_TEMPLATE="producer-orders.template"
PROPERTIES_FILE="producer-orders.properties"
...
highlight_stderr mvn exec:java \
  -Dexec.mainClass=io.confluent.wvella.demo.datacontractsv1.ProducerAvroOrders \
  -Dexec.args="producer-orders.properties"
